      ...
      <main>
        <section className="novidades">
          <div className="produto">
            ...
            <h2>Sweet Tooth</h2>
            <p>Explosão doce e envolvente que desperta os sentidos com charme e ousadia.</p>
          ...
          <div className="produto">
            ...
            <h2>Mon Pariz</h2>
            <p>Um convite à paixão intensa — uma fragrância que captura o arrepio do amor à primeira vista.</p>
          ...
          <div className="produto">
            ...
            <p>Thank U Next — doce, confiante e feita para quem escreve sua própria história.</p>
